...
function Login() {
  ...
  return (
    <div className="bg-black flex justify-center items-center h-screen">
      ...
      <button onClick={()=>navigate('/register')} class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
        Register
      </button>
        </div>
      </div>
